                ...
                public:
                    ...
                    */
                    int predict(float *x) {
                        ...
                        decisions[0] = 1.452844496978
                        + kernels[0] * 0.67075289031
                        + kernels[2] * 0.077097563476
                        + kernels[14] * -0.747850453786
                        ;
                        decisions[1] = 1.507713125178
                        + kernels[0] * 0.043820415076
                        + kernels[1] * 0.159872086718
                        + kernels[15] * -0.203692501794
                        ;
                        decisions[2] = 6.78097118511
                        + kernels[3]
                        + kernels[4]
                        + kernels[5]
                        + kernels[6]
                        ...
                        - kernels[19]
                        - kernels[20]
                        + kernels[21] * -0.437859817863
                        - kernels[22]
                        - kernels[23]
                        + kernels[24] * -0.645105347981
                        + kernels[25] * -0.160296720576
                        - kernels[26]
                        ;
